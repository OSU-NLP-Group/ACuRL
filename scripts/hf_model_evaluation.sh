...
LOG_FILE="./logs/${Model_name}/evaluation/base_model_$(date +%Y%m%d_%H%M%S).log"
...
train_task_pool_file_name="libreoffice_impress.environment_exploration.json"
train_task_pool_file="./data/tasks/task_index/${train_task_pool_file_name}"

parquet_dir="./data/tasks/parquet/${Model_name}/evaluation/base_model"

val_categories=("libreoffice_calc" "ow-xlsx" "libreoffice_writer" "ow-docx" "thunderbird" "libreoffice_impress" "ow-pptx" "KAlgebra" "Celestia")
...
python3 ./prepare_data.py \
  ...
  --data_dir "$data_dir" \
  --train_category "libreoffice_impress" \
...
image_save_dir="${Model_name}/evaluation/base_model"
eval_experiment_name="${Model_name}/evaluation/base_model"
