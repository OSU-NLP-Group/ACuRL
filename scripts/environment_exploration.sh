...
mkdir -p "./logs/${Model_name}/environment_exploration"
LOG_FILE="./logs/${Model_name}/environment_exploration/${SOFTWARE}_$(date +%Y%m%d_%H%M%S).log"
...
python3 ./prepare_data.py \
    ...
    --local_dir ./data/tasks/parquet/${SOFTWARE}/${Model_name}/environment_exploration \
    --task_copy_times 2
...
ray job submit --address="http://127.0.0.1:8265" \
    ...
    data.train_files=./data/tasks/parquet/${SOFTWARE}/${Model_name}/environment_exploration/train.parquet \
    data.val_files=./data/tasks/parquet/${SOFTWARE}/${Model_name}/environment_exploration/train.parquet \
    ...
    +env.image_save_dir=${Model_name}/environment_exploration/${SOFTWARE} \
    trainer.resume_mode=auto \
    trainer.resume_from_path=null \
    trainer.critic_warmup=0 \
    trainer.logger=['console','wandb'] \
    trainer.project_name='ACuRL' \
    trainer.experiment_name=${Model_name}/environment_exploration/${SOFTWARE} \
