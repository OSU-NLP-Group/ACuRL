...
def compute_data_metrics(batch: DataProto, use_critic: bool = True) -> dict[str, Any]:
    ...
    Returns:
        A dictionary of metrics including:
            ...
            - critic/rewards/mean, max, min, var: Statistics about sequence rewards
    ...
    reward_var = torch.var(non_aborted_sequence_reward).detach().item()
